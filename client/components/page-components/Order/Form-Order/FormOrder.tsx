...
const FormOrder: FC<FormOrderProps> = ({ setShow, order }): JSX.Element => {
  ...
  const onSubmit = (data: IDataShopper) => {
    ...
    const orderData: IOrder = {
      ...
      productCart: order.map((item) => item._id),
  ...
  return (
    <>
      ...
      <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="text-gray-600 font-semibold text-base text-right my-[10px] ">
          К оплате: {totalPrice} р.
        </div>
