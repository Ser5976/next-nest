...
const CategoryProduct = dynamic(
  () =>
    import(
      '../../components/page-components/Admin/Category-Product/CategoryProduct'
    ),
  { ssr: false }
);

const AdminCategoryProductPage: NextPageAuth<
  AdminCategoryProductProps
> = ({}) => {
  return (
...
AdminCategoryProductPage.isOnlyAdmin = true; //только для админа

// подключаем редакс к getStaticProps при помощи wrapper
export const getStaticProps: GetStaticProps<AdminCategoryProductProps> =
