...
const Articles = dynamic(
  () => import('../../components/page-components/Admin/For-Customers/Articles'),
  { ssr: false }
);

const AdminForCustomersPage: NextPageAuth<AdminForCustomersProps> = ({}) => {
  return (
...
AdminForCustomersPage.isOnlyAdmin = true; //только для админа

// подключаем редакс к getStaticProps при помощи wrapper
export const getStaticProps: GetStaticProps<AdminForCustomersProps> =
...
interface AdminForCustomersProps {
  forCustomers: IArticle[];
  categoryProduct: ICategoryProduct[];
  productType: IType[];
}

export default AdminForCustomersPage;
