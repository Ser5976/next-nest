...
const News = dynamic(
  () => import('../../components/page-components/Admin/News/News'),
  { ssr: false }
);

const AdminNewsPage: NextPageAuth<AdminNewsProps> = ({}) => {
  return (
...
AdminNewsPage.isOnlyAdmin = true; //только для админа

// подключаем редакс к getStaticProps при помощи wrapper
export const getStaticProps: GetStaticProps<AdminNewsProps> =
