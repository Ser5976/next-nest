...
const ProductType = dynamic(
  () =>
    import('../../components/page-components/Admin/Product-Type/ProductType'),
  { ssr: false }
);

const AdminProductTypePage: NextPageAuth<AdminProductTypeProps> = ({}) => {
  return (
...
AdminProductTypePage.isOnlyAdmin = true; //только для админа

// подключаем редакс к getStaticProps при помощи wrapper
export const getStaticProps: GetStaticProps<AdminProductTypeProps> =
...
interface AdminProductTypeProps {
