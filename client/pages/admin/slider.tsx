...
const Slider = dynamic(
  () => import('../../components/page-components/Admin/Slider/Slider'),
  { ssr: false }
);

const AdminSliderPage: NextPageAuth = () => {
  return (
...
AdminSliderPage.isOnlyAdmin = true; //только для админа

// подключаем редакс к getStaticProps при помощи wrapper
export const getStaticProps: GetStaticProps<AdminSliderProps> =
